...
export const projectData = [
  ...
  },
  {
    ...
    description:
      "FPortfolio is a Facebook-style developer portfolio that presents projects as social media posts. The frontend is built with React and Tailwind CSS v4, featuring a Facebook-inspired profile layout with a sticky sidebar, a project feed with multi-photo galleries, and a theater-mode post detail view. The backend is an Express API backed by Supabase (PostgreSQL + Storage), where anonymous guests identified by a client-generated UUID can like projects and post comments, with Row Level Security enforcing public reads and guest inserts.",
    features: [
